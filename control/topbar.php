      ...
      <div class="float-right">
        <div class=" dropdown mr-4">
          ...
          <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.9em;">
            <a class="dropdown-item" href="../admin/index.php"><i class="fa fa-tachometer-alt"></i> Painel Gerencial</a>
            <a class="dropdown-item" href="javascript:void(0)" id="manage_my_account"><i class="fa fa-cog"></i> Gerenciar conta</a>
            <a class="dropdown-item" href="../admin/ajax.php?action=logout"><i class="fa fa-power-off"></i> Sair</a>
          </div>
        </div>
      </div>
    </div>
...
<script>
  $('#manage_my_account').click(function() {
    uni_modal("Gerenciar Conta", "../admin/edit_user.php?id=<?php echo $_SESSION['login_id'] ?>&mtype=own")
  })
</script>