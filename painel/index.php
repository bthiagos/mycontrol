...
<?php session_start();
if (!isset($_SESSION['login_resp_id']) and ($_SESSION['login_resp_confirmado']) == 0) {
  session_destroy();
...
<!-- <script>
  window.rwbp = {
    email: 'thiago.santos@escolaedem.com.br',
    phone: '+5521970027164',
    message: 'Olá, me conta quem é você e em que posso ajudar?',
    lang: 'pt-BR'
  }
</script>
<script defer async src='assets/js/whats.js'></script> -->
